...
TARGET		:=  Colroth
BUILD		:=	build
SOURCES		:=	src/Engine src/States src
INCLUDES	:=	src  
ROMFS       :=  data

APP_TITLE		:= Time Of Colroth
APP_DESCRIPTION	:= A tile based JRPG
APP_AUTHOR		:= krruzic
...
LIBS	:= -lSDL_mixer -lSDL_ttf -lfreetype -lbz2 -lmikmod -lmad -logg -lSDL_image -lSDL -lpng -ljpeg -lz -lcitro3d -lctru
